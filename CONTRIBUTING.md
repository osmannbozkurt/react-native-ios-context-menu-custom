...
To edit the Objective-C files, open `example/ios/IosContextMenuExample.xcworkspace` in Xcode and find the source files at `Pods > Development Pods > react-native-ios-context-menu-custom`.
